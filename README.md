...
- Dự án là hệ thống kết hợp giữa Python (xử lý dữ liệu đầu vào) và Node.js (điều khiển thiết bị thực thi).
...
3. Hướng dẫn cách chạy chi tiết
...
- Bash : pip install google-api-python-client google-auth-httplib2 google-auth-oauthlib pandas
